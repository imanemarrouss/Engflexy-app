package ma.zsmart.engflexy.zynerator.export;

import com.itextpdf.text.*;
import com.itextpdf.text.Font.FontFamily;
import com.itextpdf.text.pdf.*;
import ma.zsmart.engflexy.zynerator.util.DateUtil;
import ma.zsmart.engflexy.zynerator.util.Utils;
...
public class PdfConfig extends PdfPageEventHelper {
    ...
    private BaseFont load(String location, String fontname) {
        try (InputStream is = new FileInputStream(Utils.getResourceFromcClassPath(location + System.getProperty("file.separator") + fontname).getFile());
            ...
            byte[] fontData = out.toByteArray();
            return BaseFont.createFont(fontname, BaseFont.CP1252, true, true, fontData, null);
        } catch (Exception ex) {
            return null;
        }
    }
