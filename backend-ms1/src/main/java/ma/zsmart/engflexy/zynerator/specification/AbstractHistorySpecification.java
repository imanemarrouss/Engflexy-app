package ma.zsmart.engflexy.zynerator.specification;
...
public abstract class AbstractHistorySpecification<Criteria extends HistCriteria, H extends HistBusinessObject> extends SpecificationHelper<Criteria, H> implements Specification<H> {
    ...
    protected AbstractHistorySpecification(Criteria criteria) {
        this.criteria = criteria;
    }

    protected AbstractHistorySpecification(Criteria criteria, boolean distinct) {
        this.criteria = criteria;
