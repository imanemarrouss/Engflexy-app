...
export class ScheduleProfEditAdminComponent extends AbstractEditController<ScheduleProfDto, ScheduleProfCriteria, ScheduleProfService>   implements OnInit {
    ...
    constructor( private scheduleProfService: ScheduleProfService , private coursService: CoursService, private profService: ProfService, private groupeEtudiantService: GroupeEtudiantService) {
